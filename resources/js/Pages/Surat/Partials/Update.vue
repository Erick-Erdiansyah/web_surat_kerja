  ...
  <AppLayout title="Update">
    ...
    <form @submit.prevent="submit" class="max-w-xl mx-auto my-8 bg-slate-100 px-6 pb-6 rounded-md" enctype="multipart/form-data">
      <div class="mb-6">
        ...
        <select v-model="form.jurusan_id" id="jurusan_id" class="border border-gray-400 p-2 w-full rounded-lg" disabled>
      ...
      <div class="mb-6">
        ...
        <select v-model="form.kategori_id" id="kategori_id" class="border border-gray-400 p-2 w-full rounded-lg" disabled>
      ...
      <div class="mb-6">
        ...
        <select v-model="form.sub_kategori_id" id="sub_kategori_id" class="border border-gray-400 p-2 w-full rounded-lg" disabled>
