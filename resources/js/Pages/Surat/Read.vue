  ...
  <AppLayout v-if="$page.props.auth.user">
    ...
    <div class="bg-gray-400">
      <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg p- mt-20">
    ...
    <div class="bg-gray-400">
      <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg p-5">
          ...
          <div class=" border-t-2 dark:border-gray-800 flex justify-center mt-5">
            <VuePDF :pdf="pdf" :page="page" :scale="1.25" />
          </div>
        </div>
      </div>
